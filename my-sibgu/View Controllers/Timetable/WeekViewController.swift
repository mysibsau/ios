...
//            point = CGPoint(x: todayView.frame.origin.x, y: todayView.frame.origin.y)
//            scrollView.setContentOffset(point, animated: true)
//            print("1")
//        } else {
//            scrollView.scrollToBottom()
//            point = CGPoint(x: todayView.frame.origin.x, y: (todayView.frame.origin.y) - (viewHeight - heightAfterToday - 100))
//        }
//
////        scrollView.setContentOffset(point, animated: true)
//    }
