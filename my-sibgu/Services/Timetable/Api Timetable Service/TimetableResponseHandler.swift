...
//    static func handleGroupTimetableResponse(groupId: Int, _ data: Data?, _ response: URLResponse?, _ error: Error?) -> (timetable: RTimetable?, groupHash: String?) {
...
//        
//        do {
//            let groupTimetableResponse = try JSONDecoder().decode(TimetableResponse.self, from: data)
//            
